      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-sm">
              Your comprehensive mental health platform. Making wellness accessible to everyone through AI-powered solutions.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-500 hover:text-primary" aria-label="GitHub">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; Saidul {currentYear} GetWell. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/cookies" className="text-gray-500 hover:text-primary text-sm">
              Cookie Policy
            </Link>
          </div>
        </div>
